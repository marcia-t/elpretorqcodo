...
CREATE TABLE `cedulas` (
  ...
  KEY `nro_abogado_cedula` (`nro_abogado`),
  CONSTRAINT `nro_abogado_cedula` FOREIGN KEY (`nro_abogado`) REFERENCES `abogados` (`id_abogado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2013-02-23 12:27:59
