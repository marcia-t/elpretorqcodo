<?php
	...
	$strPageTitle = QApplication::Translate('Declaratoriases') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<div id="titleBar">
		...
		<h1><?php _t('Declaratoriases'); ?></h1>
	</div>

	<?php $this->dtgDeclaratoriases->Render(); ?>

	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/declaratorias_edit.php"><?php _t('Create a New'); ?> <?php _t('Declaratorias');?></a>
	</p>
