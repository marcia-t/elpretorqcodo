<?php
	 ...
	 * @subpackage Drafts
	 */
	class TramitesAsignadosEditPanel extends QPanel {
		...
		public $lblIdTramiteAsignado;
		public $lstIdAgenteObject;
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdTramiteAsignado = null, $strControlId = null) {
			// Call the Parent
			try {
			...
			$this->strTemplate = 'TramitesAsignadosEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the TramitesAsignadosMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctTramitesAsignados = TramitesAsignadosMetaControl::Create($this, $intIdTramiteAsignado);
