...
<link href="menu_assets/styles.css" rel="stylesheet" type="text/css">
	...
	<div id='cssmenu'>
		<ul>
			...
			<li class='has-sub'><a href='#'><span>Tr�mites</span> </a>
				<ul>
					<li class='has-sub'><a href='#'><span>Listados</span> </a>
						<ul>
							<li><a href='/app/tramites_asignados_list.php'><span>Ver todos
										los tr�mites</span> </a></li>
							<li><a href='/app/tramites_asignados_que_vencen_esta_semana.php'><span>Tr�mites
										que vencen esta semana</span> </a></li>
							<li><a href='/app/tramites_asignados_en_curso.php'><span>Ver
										tr�mites en curso</span> </a></li>
						</ul>

						<li><a href='/app/buscar_tramites.php'><span>Buscar tr�mite</span>
						</a></li>
						<li><a href='/app/tramites_asignados_edit.php'><span>Asignar nuevo
									tr�mite</span> </a></li>

						<li><a href='/app/carpeta_tramites.php'><span>Carpeta de tr�mites</span>
						</a></li>
			...
			<li class='has-sub'><a href='#'><span>Sistema</span> </a>
				<ul>
					...
					<li class='has-sub'><a href='#'><span>Tipo de tr�mites</span> </a>
						<ul>
			...
			<li class='has-sub'><a href='#'><span>C�dulas</span> </a>
				<ul>
