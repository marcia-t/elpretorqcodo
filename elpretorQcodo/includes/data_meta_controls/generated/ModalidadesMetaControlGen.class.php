<?php
	...
	class ModalidadesMetaControlGen extends QBaseClass {
		...
		public function lblObservaciones_Create($strControlId = null) {
			...
			$this->lblObservaciones->Text = $this->objModalidades->Observaciones;
		...
		public function Refresh($blnReload = false) {
			...
			if ($this->txtObservaciones) $this->txtObservaciones->Text = $this->objModalidades->Observaciones;
			if ($this->lblObservaciones) $this->lblObservaciones->Text = $this->objModalidades->Observaciones;
