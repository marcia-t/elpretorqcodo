<?php
	 ...
	 * @subpackage Drafts
	 */
	class AbogadosEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the AbogadosMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctAbogados = AbogadosMetaControl::CreateFromPathInfo($this);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction('�Est� seguro de eliminar este abogado?'));
		...
		protected function RedirectToListPage() {
			QApplication::Redirect('abogados_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// abogados_edit.tpl.php as the included HTML template file
	AbogadosEditForm::Run('AbogadosEditForm');
?>
