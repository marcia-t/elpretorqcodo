<?php
	 ...
	 * @subpackage Drafts
	 */
	class BuscarAbogadosPopupForm extends QDialogBox {
		...
		protected function __construct($strCloseCallback, $objParentObject, $strControlId = null)  {
	...
	BuscarAbogadosPopupForm::Run('BuscarAbogadosPopupForm');
