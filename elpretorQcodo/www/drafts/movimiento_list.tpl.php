<?php
	...
	$strPageTitle = QApplication::Translate('Movimientos') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<div id="titleBar">
		...
		<h1><?php _t('Movimientos'); ?></h1>
	</div>

	<?php $this->dtgMovimientos->Render(); ?>

	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/movimiento_edit.php"><?php _t('Create a New'); ?> <?php _t('Movimiento');?></a>
	</p>
