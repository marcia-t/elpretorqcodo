<?php
	 ...
	 * @subpackage Drafts
	 */
	class ModalidadesEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the ModalidadesMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctModalidades = ModalidadesMetaControl::CreateFromPathInfo($this);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction('¿Está seguro de eliminar esta modalidad?'));
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/modalidades_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// modalidades_edit.tpl.php as the included HTML template file
	ModalidadesEditForm::Run('ModalidadesEditForm');
?>