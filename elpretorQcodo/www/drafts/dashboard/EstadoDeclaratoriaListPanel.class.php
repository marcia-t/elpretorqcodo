<?php
	 ...
	 * list a collection of EstadoDeclaratoria objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this EstadoDeclaratoriaListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class EstadoDeclaratoriaListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list EstadoDeclaratorias
		public $dtgEstadoDeclaratorias;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'EstadoDeclaratoriaListPanel.tpl.php';
			...
			$this->dtgEstadoDeclaratorias->ItemsPerPage = 8;
			...
			$this->dtgEstadoDeclaratorias->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('EstadoDeclaratoria');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new EstadoDeclaratoriaEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new EstadoDeclaratoriaEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
