<?php
	...
	class DeclaratoriasEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdDeclaratoria = null, $strControlId = null) {
			// Call the Parent
			try {
			...
			$this->strTemplate = 'DeclaratoriasEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the DeclaratoriasMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctDeclaratorias = DeclaratoriasMetaControl::Create($this, $intIdDeclaratoria);

			// Call MetaControl's methods to create qcontrols based on Declaratorias's data fields
			$this->lblIdDeclaratoria = $this->mctDeclaratorias->lblIdDeclaratoria_Create();
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('Declaratorias') . '?'));
