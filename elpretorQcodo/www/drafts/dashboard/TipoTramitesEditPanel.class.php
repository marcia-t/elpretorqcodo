<?php
	...
	class TipoTramitesEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdTipoTramite = null, $strControlId = null) {
			// Call the Parent
			try {
			...
			$this->strTemplate = 'TipoTramitesEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the TipoTramitesMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctTipoTramites = TipoTramitesMetaControl::Create($this, $intIdTipoTramite);
