<?php
	...
	class MovimientoEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdMovimiento = null, $strControlId = null) {
			// Call the Parent
			try {
			...
			$this->strTemplate = 'MovimientoEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the MovimientoMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctMovimiento = MovimientoMetaControl::Create($this, $intIdMovimiento);

			// Call MetaControl's methods to create qcontrols based on Movimiento's data fields
			$this->lblIdMovimiento = $this->mctMovimiento->lblIdMovimiento_Create();
