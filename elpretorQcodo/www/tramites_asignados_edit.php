...
class TramitesAsignadosEditForm extends QForm {
	 ...
	 * It willalso Blink() on all invalid controls, as well as Focus() on the top-most invalid control.
	 */
	...
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_APP__ . '/buscar_tramites.php');
	}
}
